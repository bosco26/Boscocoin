...
"""Verify that starting boscocoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start boscocoin with -h for help text")
        ...
        self.log.info("Start boscocoin with -version for version information")
        ...
        self.log.info("Start boscocoind with -fakearg to make sure it does not start")
