...
{
    const char* pszTimestamp = "FORBES 17/FEB/2022 Crypto’s Gone Mainstream; Here’s What Comes Next";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1645075769, 2084802997, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xb2045838c0fb7bd7bed8b05b901562ea8975ee6e66f91f273e1c833785adaa2"));
        assert(genesis.hashMerkleRoot == uint256S("0xeb8cca753cc06000db76ff95543e383d1b6c4b7a666073636cd2b1961446c4b0"));
        ...
        vSeeds.emplace_back("seed-a.boscocoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.boscocointools.com");
        vSeeds.emplace_back("dnsseed.boscocoinpool.org");
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 3.5 * 24 * 60 * 60; // 3.5 days
        consensus.nPowTargetSpacing = 2.6 * 60;
        ...
        vSeeds.emplace_back("testnet-seed.boscocointools.com");
        vSeeds.emplace_back("seed-b.boscocoin.loshan.co.uk");
