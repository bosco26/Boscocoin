...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " boscocoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  boscocoin-tx [options] <hex-tx> [commands]  Update hex-encoded boscocoin transaction\n" +
            "or:     boscocoin-tx [options] -create [commands]   Create hex-encoded boscocoin transaction\n" +
            "\n";
