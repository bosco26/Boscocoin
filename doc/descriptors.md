# Support for Output Descriptors in Boscocoin Core

Since Boscocoin Core v0.17, there is support for Output Descriptors. This is a
...
on Boscocoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Boscocoin Core wallets, a convenience function `combo` is
